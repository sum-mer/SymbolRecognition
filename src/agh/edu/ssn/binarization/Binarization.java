package agh.edu.ssn.binarization;
...
import agh.edu.ssn.gui.GuiCreator;
...
public class Binarization {
    ...
    public BufferedImage makeBinarization(BufferedImage originalImg) throws IOException {
 
        grayscale = toGray(originalImg);
